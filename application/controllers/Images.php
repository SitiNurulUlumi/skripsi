...
class Images extends CI_Controller
{
    ...
    public function list()
    {
        ...
        $data['subtitle'] = 'List Video Jenis Kendaraan';
        $data['role_list'] = '3';
    ...
    public function tambah()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            $config['upload_path']          = FCPATH . '/scanner/video/';
        ...
        $data['title'] = 'Video Jenis Kendaraan';
        $data['subtitle'] = 'Tambah Video Jenis Kendaraan';
        $data['role_list'] = '3';
    ...
    public function keluar()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            if (!$this->upload->do_upload('plat')) {
                ...
                $uploaded_data = $this->upload->data();
                header('Location: ' . base_url() . 'scanner/test2.php');
        ...
        // $this->load->view('admin/setting_upload_avatar.php', $data);
        $data['title'] = 'Foto Nomor Plat  Keluar';
        $data['subtitle'] = 'Tambah Foto Nomor Plat Keluar';
        $data['role_list'] = '3';
    ...
    public function video_feed(){
    $video_feed_url = escapeshellcmd('python copymain.py');
    $output = shell_exec($command);
    header("Location: http://localhost/big/history/");
    echo '<img src="'.$video_feed_url.'" alt="Camera Feed" />';}
